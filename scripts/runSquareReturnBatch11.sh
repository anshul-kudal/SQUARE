#!/usr/bin/env bash
# Batch R11 — 12 settings / variance / export-flag refund TCs (24 interactions).
#
# Usage:
#   ./scripts/runSquareReturnBatch11.sh
#   TAG=batchr11 RESUME='BatchR11TipVarianceFullRefund:5' ./scripts/runSquareReturnBatch11.sh
set -euo pipefail
cd "$(dirname "$0")/.."

export SUITE="Square_Suite/Return_Import"
export TAG="${TAG:-batchr11}"
...
LOG="/tmp/square_return_batch11.log"

echo "=============================================="
echo " Square Return/Refund — Batch R11 (12 TCs)"
...
node scripts/generateSquareReturnBatch11.js
