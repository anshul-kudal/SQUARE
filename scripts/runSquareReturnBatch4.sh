#!/usr/bin/env bash
# Batch R4 — 18 tip & tip+discount refund permutation TCs (36 interactions).
#
# Usage:
#   ./scripts/runSquareReturnBatch4.sh
#   TAG=batchr4 RESUME='BatchR4TipLineFullRefund:5' ./scripts/runSquareReturnBatch4.sh
set -euo pipefail
cd "$(dirname "$0")/.."

export SUITE="Square_Suite/Return_Import"
export TAG="${TAG:-batchr4}"
...
LOG="/tmp/square_return_batch4.log"

echo "=============================================="
echo " Square Return/Refund — Batch R4 (18 TCs)"
...
node scripts/generateSquareReturnBatch4.js
