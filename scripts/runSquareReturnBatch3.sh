#!/usr/bin/env bash
# Batch R3 — 20 line & cart/order discount permutation refund TCs (40 interactions).
#
# Usage:
#   ./scripts/runSquareReturnBatch3.sh
#   TAG=batchr3 RESUME='BatchR3LineDisc25FullRefund:5' ./scripts/runSquareReturnBatch3.sh
set -euo pipefail
cd "$(dirname "$0")/.."

export SUITE="Square_Suite/Return_Import"
export TAG="${TAG:-batchr3}"
...
LOG="/tmp/square_return_batch3.log"

echo "=============================================="
echo " Square Return/Refund — Batch R3 (20 TCs)"
...
node scripts/generateSquareReturnBatch3.js
