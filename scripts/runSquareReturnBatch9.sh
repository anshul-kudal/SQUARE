#!/usr/bin/env bash
# Batch R9 — 16 lot / serial / inventory-detail refund TCs (32 interactions).
#
# Usage:
#   ./scripts/runSquareReturnBatch9.sh
#   TAG=batchr9 RESUME='BatchR9SerialSingleFullRefund:5' ./scripts/runSquareReturnBatch9.sh
set -euo pipefail
cd "$(dirname "$0")/.."

export SUITE="Square_Suite/Return_Import"
export TAG="${TAG:-batchr9}"
...
LOG="/tmp/square_return_batch9.log"

echo "=============================================="
echo " Square Return/Refund — Batch R9 (16 TCs)"
...
node scripts/generateSquareReturnBatch9.js
