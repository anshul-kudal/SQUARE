#!/usr/bin/env bash
# Batch R5 — 22 tax-exposed multi-line refund permutation TCs (44 interactions).
#
# Usage:
#   ./scripts/runSquareReturnBatch5.sh
#   TAG=batchr5 RESUME='BatchR5TaxInclSingleFullRefund:5' ./scripts/runSquareReturnBatch5.sh
set -euo pipefail
cd "$(dirname "$0")/.."

export SUITE="Square_Suite/Return_Import"
export TAG="${TAG:-batchr5}"
...
LOG="/tmp/square_return_batch5.log"

echo "=============================================="
echo " Square Return/Refund — Batch R5 (22 TCs)"
...
node scripts/generateSquareReturnBatch5.js
