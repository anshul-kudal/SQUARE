#!/usr/bin/env bash
# Batch R6 — 16 modifier/custom-amount refund TCs (32 interactions).
#
# Usage:
#   ./scripts/runSquareReturnBatch6.sh
#   TAG=batchr6 RESUME='BatchR6ModFullRefund:5' ./scripts/runSquareReturnBatch6.sh
set -euo pipefail
cd "$(dirname "$0")/.."

export SUITE="Square_Suite/Return_Import"
export TAG="${TAG:-batchr6}"
...
LOG="/tmp/square_return_batch6.log"

echo "=============================================="
echo " Square Return/Refund — Batch R6 (16 TCs)"
...
node scripts/generateSquareReturnBatch6.js
